...
export interface StaggerSocial {
  label: string;
  link: string;
}
...
export function StaggeredMenu({
  ...
  const handleItemClick = (e: React.MouseEvent, link: string) => {
    e.preventDefault();
    closeMenu();
    // Laisse le panneau se refermer avant le scroll
    setTimeout(() => onItemClick?.(link), 150);
  };
  ...
  return (
    ...
    >
      ...
      <header className="staggered-menu-header" aria-label="Navigation principale mobile">
      ...
      <aside id="staggered-menu-panel" ref={panelRef} className="staggered-menu-panel" aria-hidden={!open}>
        <div className="sm-panel-inner">
            ...
            {items && items.length ? (
              ...
              <li className="sm-panel-itemWrap" aria-hidden="true">
                <span className="sm-panel-item">
                  <span className="sm-panel-itemLabel">Aucun lien</span>
                </span>
              </li>
            )}
          </ul>
          {displaySocials && socialItems && socialItems.length > 0 && (
            <div className="sm-socials" aria-label="Liens de contact">
              <h3 className="sm-socials-title">Contact</h3>
          ...
          {cvUrl && (
            <div className="sm-cv">
              <a href={cvUrl} download className="sm-cv-link sm-socials-link">
                Télécharger le CV
              </a>
            </div>
          )}
